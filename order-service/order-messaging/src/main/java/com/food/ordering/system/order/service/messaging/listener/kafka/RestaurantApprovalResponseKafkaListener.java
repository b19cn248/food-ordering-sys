  ...
  public void receive(@Payload List<RestaurantApprovalResponseAvroModel> messages,
    ...
    messages.forEach(restaurantApprovalResponseAvroModel -> {
      if (restaurantApprovalResponseAvroModel.getOrderApprovalStatus().equals(OrderApprovalStatus.APPROVED)) {
        ...
        log.info("Processing rejected order for order id: {}, with failure messages: {}", restaurantApprovalResponseAvroModel.getOrderId(), String.join(",", restaurantApprovalResponseAvroModel.getFailureMessages()));
